...
export default function CompetitorTable({ competitors }: CompetitorTableProps) {
  ...
  return (
    <div className="bg-gray-900/50 border border-gray-700 shadow-lg overflow-hidden sm:rounded-lg">
        ...
        <table className="min-w-full divide-y divide-gray-700">
          ...
          <tbody className="bg-gray-800/30 divide-y divide-gray-700">
            {competitors.map((competitor, index) => (
                  <tr key={index} className={index === 0 ? 'bg-gray-800/20 border-l-4 border-l-gray-500' : 'hover:bg-gray-700/30'}>
